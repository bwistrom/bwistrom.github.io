class FuturisticWorkspace {
    ...
    createMirroredDimension() {
        // Create a group for mirrored elements
        const mirroredGroup = new THREE.Group();

        // Create pentagon globe
        const pentagonGeometry = new THREE.DodecahedronGeometry(1, 0);
        const pentagonMaterial = new THREE.ShaderMaterial({
            ...
            fragmentShader: `
                ...
                void main() {
                    ...
                    // Add MW text effect
                    float textEffect = text(vUv, vec2(0.5, 0.5), 0.2);
                    finalColor = mix(finalColor, vec3(1.0), textEffect * 0.5);
        ...
        pentagonGlobe.position.set(-5, 2, -5); // Mirrored position

        // Create energy rings around the pentagon
        for (let i = 0; i < 3; i++) {
        ...
        // Add to mirrored group
        mirroredGroup.add(pentagonGlobe);

        // Add to scene
        this.scene.add(mirroredGroup);

        // Store reference for animation
        this.mirroredDimension = mirroredGroup;
    }
