...
### 🇸🇪 Swedish Flag Globe Feature
- **Swedish Blue Base**: Globe rendered in authentic Swedish flag blue (#006aa7)
- **Swedish Yellow Wireframe**: Overlaid wireframe in Swedish flag yellow (#fecc00)
- **Dual Animation**: Both spheres rotate at different speeds for dynamic effect
- **Patriotic Design**: Honors Swedish heritage with official flag colors
